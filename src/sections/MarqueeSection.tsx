...
const repeatedRow1 = [...row1Images, ...row1Images, ...row1Images];
const repeatedRow2 = [...row2Images, ...row2Images, ...row2Images];
...
export const MarqueeSection = () => {
  ...
  return (
    <section id="marquee-section" className="bg-[#0C0C0C] pt-24 sm:pt-32 md:pt-40 pb-10 overflow-hidden flex flex-col gap-3">
      <div 
